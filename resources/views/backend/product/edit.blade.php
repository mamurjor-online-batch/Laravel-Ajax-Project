                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $product->product_name }}" class="form-control form-control-sm" name="product_name" id="product_name">
                                @error('product_name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $product->product_slug }}" class="form-control form-control-sm" name="product_slug" id="product_slug">
                                @error('product_slug')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $product->product_code }}" class="form-control form-control-sm" name="product_code" id="product_code">
                                @error('product_code')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" value="{{ $product->qty }}" class="form-control form-control-sm" name="qty" id="quantity">
                                @error('qty')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" value="{{ $product->price }}" class="form-control form-control-sm" name="price" id="price">
                                @error('price')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <img width="60" height="60" src="{{ $product->image != null ? asset('images/products/'.$product->image) : 'https://via.placeholder.com/60' }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
